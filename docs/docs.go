                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.AIChatRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.AIChatResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "Book": {
            ...
            "properties": {
                ...
                "summary": {
                    "type": "string",
                    "example": "A gripping dystopian classic about surveillance and control, following Winston Smith as he questions the Party's reality. Orwell's chilling vision explores truth, freedom, and resistance under totalitarian rule."
                },
                "total_reviews": {
                    "type": "integer",
                    "example": 128
